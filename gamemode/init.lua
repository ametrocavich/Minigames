...
AddCSLuaFile( "AntiCheat/cl_AntiCheat.lua" )
...
include( "AntiCheat/CvarCheck/sn3_base_incoming.lua" )
include( "AntiCheat/CvarCheck/sn3_base_netmessages.lua" )
include( "AntiCheat/CvarCheck/sn3_base_querycvar.lua" )
include( "AntiCheat/CvarCheck/sn3_base_sv.lua" )
include( "AntiCheat/cl_AntiCheat.lua" )
include( "AntiCheat/AntiCheat.lua" )
